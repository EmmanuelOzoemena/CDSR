...
export default function StaffTabs() {
  ...
  return (
    <>
      ...
      <div className="dashboard__inner__main__title">Super dashboard</div>

      <div className="dashboard__inner__main__tabs">
        <div
          className={
            !pathname?.split("/")[3]
              ? "dashboard__inner__main__tabs__item dashboard__inner__main__tabs__active"
              : "dashboard__inner__main__tabs__item"
          }
          onClick={() => (window.location.href = "/justice/dashboard")}
        >
          User Management
        ...
        <div
          ...
          onClick={() =>
            (window.location.href = "/justice/dashboard/departments")
          }
        >
        ...
        <div
          ...
          onClick={() => (window.location.href = "/justice/dashboard/support")}
        >
          Support & Feedback
        </div>
        ...
        <div
          ...
          onClick={() =>
            (window.location.href = "/justice/dashboard/notifications")
          }
        >
          Notification{" "}
        </div>
        ...
        <div
          ...
          onClick={() =>
            (window.location.href = "/justice/dashboard/access-control")
          }
        >
          Access Control
        </div>

        <div className="dashboard__inner__main__tabs__item">Email</div>
        ...
        <div
          ...
          onClick={() => (window.location.href = "/justice/dashboard/logs")}
        >
          Log Activites
        </div>
      </div>
