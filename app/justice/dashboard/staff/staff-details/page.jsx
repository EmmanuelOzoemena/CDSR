...
const StaffDetails = ({ isOpen, onClose }) => {
  ...
  const [currentTab, setCurrentTab] = useState("Domestic Staff Information");
            ...
            <div className="security-details__container__content__tags">
              <div
                className={`security-details__container__content__tags__tab ${
                  currentTab === "Domestic Staff Information"
                    ? "active-tab"
                    : ""
                }`}
                onClick={() => handleCurrentTab("Domestic Staff Information")}
              >
                Domestic Staff Info
              </div>
              ...
              <div
                className={`security-details__container__content__tags__tab ${
                  currentTab === "Medical History" ? "active-tab" : ""
                }`}
              ...
              <>
                <div className="security-details__container__content__more-info">
                  ...
                  <div className="security-details__container__content__more-info__grid">
                    ...
                    <div>
                      <h2>Email Address:</h2>
                      <p>dozie4@gmail.com</p>
                    </div>

                    <div>
                      <h2>Last Known Address:</h2>
                      <p>16B Fred Avenue, Ikeja</p>
                    </div>
                  </div>
