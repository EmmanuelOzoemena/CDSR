...
const DriverDetails = ({ isOpen, onClose }) => {
  ...
  const [currentTab, setCurrentTab] = useState("Driver Information");
            ...
            <div className="security-details__container__content__tags">
              <div
                className={`security-details__container__content__tags__tab ${
                  currentTab === "Driver Information" ? "active-tab" : ""
                }`}
                onClick={() => handleCurrentTab("Driver Information")}
              >
                Driver Info
              </div>
              ...
              <>
                <div className="security-details__container__content__more-info">
                  ...
                  <div className="security-details__container__content__more-info__grid">
                    ...
                    <div>
                      <h2>Email Address:</h2>
                      <p>divnie@gmail.com</p>
                    </div>

                    <div>
                      <h2>Last Known Address:</h2>
                      <p>No 4 Ajasa Close, Ojodu, Ikeja</p>
                    </div>
                  </div>
