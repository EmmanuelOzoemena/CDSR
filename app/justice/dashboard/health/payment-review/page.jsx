...
// import AddedSecurity from "../added-security/page";
// import Image from "next/image";

const PaymentReview = ({ isOpen, onClose, totalPayment }) => {
  ...
  return (
    <div className="payment-review">
      <div className="payment-review__overlay" onClick={onClose}></div>
      <div className="payment-review__content">
        <div className="payment-review__content__heading">
          <h2 className="payment-review__content__heading__title">Hi, Alexander</h2>

          <div className="payment-review__content__heading__flex">
            <div>
              <svg
                width="20"
                height="20"
        ...
        <div className="payment-review__content__hero">
          <h2 className="payment-review__content__hero__title">Payment Methods</h2>
        ...
        <div className="payment-review__content__reg">
          <h2>Registration Fee</h2>

          <h4>N{totalPayment.toLocaleString()}.00</h4>
        </div>

        <div className="payment-review__content__wallet">
          <h2 className="payment-review__content__wallet__title">Wallet</h2>

          <div className="payment-review__content__wallet__details">
            <div className="payment-review__content__wallet__details__amount">
              Wallet Balance
              <br />
              <span>N100,000</span>
            </div>

            <div className="payment-review__content__wallet__details__btn">
              Pay with Wallet
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
          ...
          {/* <div className="payment-review__content__wallet__btn">
            Fund Wallet
        ...
        <h2 className="payment-review__content__card-title">Card</h2>

        <div className="payment-review__content__card-section">
          <div className="payment-review__content__card-section__card">
            <div className="payment-review__content__card-section__card__heading">
              <div>**** 5969</div>
            ...
            <div className="payment-review__content__card-section__card__details">
        ...
        <div className="payment-review__content__card-data">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
