...
const Report = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="new-security">
      <div className="new-security__overlay" onClick={onClose}></div>
      <div className="new-security__content">
        <header className="new-security__header">
          <div>
            <svg
              width="24"
              height="24"
        ...
        <div className="new-security__content__heading">
          <div></div>

          <div className="new-security__content__heading__svg">
            <svg
              width="34"
              height="34"
              viewBox="0 0 48 48"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect width="48" height="48" rx="24" fill="#009B07" />
              <path
                d="M26.2088 16.4545V31H23.5739V19.0185H23.4886L20.0866 21.1918V18.777L23.7017 16.4545H26.2088Z"
                fill="white"
              />
            </svg>
            ...
            >
              ...
              <path
                d="M16.7926 29V27.0966L21.8423 22.1463C22.3253 21.6586 22.7277 21.2254 23.0497 20.8466C23.3717 20.4678 23.6132 20.1009 23.7741 19.7457C23.9351 19.3906 24.0156 19.0118 24.0156 18.6094C24.0156 18.1501 23.9115 17.7571 23.7031 17.4304C23.4948 17.099 23.2083 16.8433 22.8438 16.6634C22.4792 16.4834 22.0649 16.3935 21.6009 16.3935C21.1226 16.3935 20.7036 16.4929 20.3438 16.6918C19.9839 16.8859 19.7045 17.1629 19.5057 17.5227C19.3116 17.8826 19.2145 18.3111 19.2145 18.8082H16.7074C16.7074 17.8849 16.9181 17.0824 17.3395 16.4006C17.7609 15.7187 18.3409 15.1908 19.0795 14.8168C19.8229 14.4427 20.6752 14.2557 21.6364 14.2557C22.6117 14.2557 23.4688 14.438 24.2074 14.8026C24.946 15.1671 25.5189 15.6667 25.9261 16.3011C26.3381 16.9356 26.544 17.66 26.544 18.4744C26.544 19.0189 26.4399 19.554 26.2315 20.0795C26.0232 20.6051 25.6563 21.1875 25.1307 21.8267C24.6098 22.4659 23.8783 23.2401 22.9361 24.1491L20.429 26.6989V26.7983H26.7642V29H16.7926Z"
                fill="white"
              />
            </svg>
          </div>

          <div className="new-security__content__heading__btn">
            {activeTab === "saveNext" && (
              <>
                <div className="new-security__content__heading__btn__cancel " 
                onClick={onClose}>
                  Cancel
                </div>
                <div
                  className={`new-security__content__heading__btn__save 
            ...
            {activeTab === "saveAndNext" && (
              <>
                ...
                {/* <div
                  ...
                  className={`new-security__content__heading__btn__save 
                    ${activeTab === "saveAndNext" ? "saveNext" : ""} `}
        ...
        <div className="new-security__container">
          {activeTab === "saveNext" && (
            <>
              {/* <div className="new-security__container__upload">
                <div className="new-security__container__upload__personal-details">
                  {images?.length < 1 && (
                    <label>
                      {!mugLoading && (
                        <input
                      ...
                      <div className="new-security__container__upload__personal-details__upload-image">
                        {!mugLoading ? (
                          <svg
                            width="95"
                            height="73"
                  ...
                  {images?.length > 0 && (
                    <div className="new-security__container__upload__personal-details__image-preview">
                      <Image
                        alt=""
                  ...
                  <div className="new-security__container__upload__personal-details__image-grid">
                    ...
                    {images?.map((item, index) => (
                      <div
                        className="new-security__container__upload__personal-details__image-grid__image"
                        key={index}
                      >
                        <Image
                          alt=""
                        ...
                        <div className="new-security__container__upload__personal-details__image-grid__image__overlay"></div>
                      </div>
                    ))}
                  </div>
                </div>

                <div className="new-security__container__upload__suspect-note">
                  <svg
                    width="7"
                    height="40"
                    viewBox="0 0 4 40"
                  ...
                  <p>Upload clear and recent Image of Driver</p>
                </div>
              </div> */}

              <div className="new-security__container__info">
                <h2 className="new-security__container__info__title">
                  Basic Information
                </h2>

                <form className="new-security__container__info__form">
                  <div>
                ...
                <form className="new-security__container__info__number">
                  <div>
                ...
                <form className="new-security__container__info__location">
                  <div>
                    ...
                    <div>
                      <svg
                        ...
                        fill="none"
                      >
                        <g clip-path="url(#clip0_2548_270021)">
                          <path
                            d="M4.6875 17.7793C5.3923 18.6639 6.0338 19.5957 6.60737 20.5679C7.09705 21.4822 7.30118 22.1023 7.65905 23.204C7.87852 23.8127 8.07688 23.9943 8.50334 23.9943C8.96805 23.9943 9.17889 23.6853 9.34178 23.2073C9.68006 22.1669 9.94548 21.3728 10.3642 20.6226C11.186 19.1741 12.207 17.8869 13.2103 16.6498C13.4819 16.2997 15.2379 14.2599 16.0285 12.6505C16.0285 12.6505 17.0002 10.8826 17.0002 8.41343C17.0002 6.10381 16.0419 4.50195 16.0419 4.50195L13.2831 5.22954L11.6076 9.57511L11.1931 10.1743L11.1102 10.2829L11 10.4188L10.8065 10.6358L10.53 10.9081L9.03804 12.105L5.308 14.2259L4.6875 17.7793Z"
                            fill="#34A853"
                          />
                          <path
                            d="M0.837891 12.3525C1.74825 14.4002 3.50377 16.2002 4.69151 17.7799L11.0002 10.4208C11.0002 10.4208 10.1114 11.5654 8.49918 11.5654C6.70336 11.5654 5.25258 10.1532 5.25258 8.37251C5.25258 7.15139 5.99859 6.3125 5.99859 6.3125L1.71611 7.44253L0.837891 12.3525Z"
                            fill="#FBBC04"
                          />
                          <path
                            d="M11.0697 0.378906C13.1649 1.04417 14.9583 2.44081 16.043 4.5003L11.0011 10.4171C11.0011 10.4171 11.7471 9.56306 11.7471 8.34952C11.7471 6.52735 10.189 5.16609 8.50584 5.16609C6.91415 5.16609 6 6.30887 6 6.30887V2.58135L11.0697 0.378906Z"
                            fill="#4285F4"
                          />
                          <path
                            d="M1.99414 2.99281C3.24557 1.51834 5.4476 0 8.48343 0C9.95632 0 11.066 0.380796 11.066 0.380796L5.99678 6.31167H2.4052L1.99414 2.99281Z"
                            fill="#1A73E8"
                          />
                          <path
                            d="M0.837516 12.352C0.837516 12.352 0 10.7369 0 8.39703C0 6.18556 0.872977 4.25248 1.99318 2.99219L5.99868 6.31158L0.837516 12.352Z"
                            fill="#EA4335"
                          />
                        </g>
                        <defs>
                          <clipPath id="clip0_2548_270021">
                      ...
                      <svg
                        ...
                        fill="none"
                      >
                        <g clip-path="url(#clip0_2923_49011)">
                          <path
                ...
                <form className="new-security__container__info__form">
                  <div>
                    <label>Last Knonw Address:</label>
                    <div>
                      <input type="text" placeholder="Enter Last Address" />
                    </div>
                  </div>
            ...
            <div className="new-security__container__info">
              ...
              <form className="new-security__container__info__form">
                ...
                <div>
                  ...
                  <div>
                    <input type="text" placeholder="Enter Driver's license" />
                  </div>
                </div>
                <div>
              ...
              <form className="new-security__container__info__employment">
                <div>
                  <label>Job Title:</label>
                  <div>
                    <select>
                      <option selected disabled>
                        Select type of Domestic Staff
                      </option>
              ...
              {employmentForms.map((_, index) => (
                <div key={index}>
                  ...
                  <form className="new-security__container__info__desc">
                    <div>
              ...
              <div className="add" onClick={handleAddEmploymentForm}>
