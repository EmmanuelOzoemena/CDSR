...
import ReviewReport from "../report-review/page";

const IncidentReport = ({ isOpen, onClose }) => {
      ...
      <div className="report-incident__content">
        ...
        <div className="report-incident__container">
          <div className="report-incident__container__heading">
            ...
            <div className="report pointer" onClick={handleOpenUserRequest}>Report</div>
            ...
            <div>
              ...
              <div>
                <select>
                  ...
                  <option value="">Emmanuel Ebuka</option>
                  <option value="">James Osho</option>
                  <option value="">Saleem Jibril</option>
                  <option value="">Ore Dare</option>
                  <option value="">Livinus Carchy</option>
                </select>
              </div>
            </div>
          </form>

          <form className="report-incident__container__staff">
            <div>
