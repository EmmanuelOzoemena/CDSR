  ...
  return (
    <main className="auth">
      ...
      <div className="auth__auth">
        ...
        <h1 className="auth__unauth__title">Request has been approved</h1>
        <h1 className="auth__unauth__subtitle">
          Request ID: <span>876545678</span>
        </h1>
      </div>
    </main>
  );
