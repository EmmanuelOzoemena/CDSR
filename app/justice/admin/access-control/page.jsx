...
export default function Departments() {
  ...
  const [isAddedRoleModalOpen, setIsAddedRoleModalOpen] = useState(false);
  ...
  const handleOpenAddedRoleModal = () => {
    setIsAddedRoleModalOpen(true);
  };

  const handleCloseAddedRoleModal = () => {
    setIsAddedRoleModalOpen(false);
  };
  ...
  return (
    <div className="access">
      <div className="access__header">
        ...
        <div className="access__header__button" onClick={handleOpenUserRequest}>
          Request{" "}
          <svg
            width="24"
            height="24"
          ...
          <table className="access-table">
            <thead>
              ...
              <tr>
                ...
                <th>Expunge</th>
                <th className="pointer" onClick={handleInviteUserOpen}>
                  Invite User
                </th>
                <th>Grant Access</th>
                <th>View Users</th>
      ...
      <InviteUser isOpen={inviteUserModal} onClose={handleInviteUserClose} />
